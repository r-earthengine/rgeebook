...
Map$addLayer(evi, list(min = -1, max = 1, palette = c("FF0000", "00FF00")), "EVI")
```
...
Map$addLayer(zones, list(min = 0, max = 3, palette = palette), "development zones")
```
...
![Figure 1. `ImageCollection` from GeoTiffs in Cloud Storage](../images/chapter_05/figure_ico.png){width=670px}

[Learn more about loading images from Cloud GeoTiffs]()

## ImageCollection Visualization {-}

Images composing an `ImageCollection` can be visualized as either an animation or a series of thumbnails referred to as a “filmstrip”. These methods provide a quick assessment of the contents of an `ImageCollection` and an effective medium for witnessing spatiotemporal change (Figure 2).
...
![Figure 2. Animation showing a three-day progression of Atlantic hurricanes in September, 2017.](../images/gif/chapter_05/gif_01.gif){width=670px}
...
Visualization of the above collection shows considerable noise in the forested regions where cloud cover is heavy (Figure 3a). A better representation can be achieved by reducing serial date ranges by median across all years in the MODIS collection.
...
|![](../images/gif/chapter_05/gif_02_1.gif){width=335px}|![](../images/gif/chapter_05/gif_02_2.gif){width=335px}|
|:--|:--|
...
```
![Figure 4. Hourly surface temperature for the northern winter solstice represented as an animated GIF image.](../images/gif/chapter_05/gif_03.gif){width=670px}
...
The following code snippet uses the same collection as the video thumb example above. Upon running this script, a filmstrip similar to Figure 5 should appear in the Rstudio console.
...
```
![Figure 5. Hourly surface temperature for the northern winter solstice represented as a filmstrip PNG image. Note that the filmstrip has been divided into four sections for display; the result of getFilmstripThumbURL is a single series of collection images joined north-south.](../images/chapter_05/figure_04.png){width=670px}
...
The following example demonstrates painting South American country borders to a blank `Image` and blending the result with each `Image` of the global daily temperature collection (Figure 6). The overlaid country boundaries distinguish land from water and provide context to patterns of temperature.
...
```
![Figure 7. Emphasize an area of interest by clipping the image and overlaying it on a muted copy.](../images/gif/chapter_05/gif_06.gif){width=760px}

You can also blend image data with a hillshade base layer to indicate terrain and give the visualization some depth (Figure 8).
...
print(ui$Thumbnail(finalVisCol, videoArgs))
```
![Figure 8. Show terrain by overlaying partially transparent image data on a hillshade layer.](../images/gif/chapter_05/gif_07.gif){width=670px}
...
With only two images in a collection, as is the case here, flicker is the default representation upon collection animation. Adjust the `framesPerSecond` animation argument to speed up or slow down the flicker rate. The following visualization arguments applied to the collection above produces Figure 9.
...
```
![Figure 9. Example of flickering between 12pm GMT surface temperature for northern and winter solstice.](../images/gif/chapter_05/gif_08.gif){width=670px}

##### Fade {-}

A fade transition between two layers is achieved by simultaneously decreasing the opacity of one layer while increasing the opacity of the other over a sequence of opacity increments from near 0 to 1 (Figure 10).
...
```
![Figure 10. Example of fading between 12pm GMT surface temperature for summer and winter solstice.](../images/gif/chapter_05/gif_09.gif){width=670px}

##### Slider {-}

A slider transition progressively shows and hides the underlying image layer. It is achieved by iteratively adjusting the opacity of the overlying image across a range of longitudes (Figure 11).
...
```
![Figure 11. Example of a sliding transition between 12pm GMT surface temperature for summer and winter solstice.](../images/gif/chapter_05/gif_10.gif){width=670px}
...
![Figure 12a. Bad composite](../images/chapter_05/figure_fic_bc.png){width=670px}
...
![Figure 12b. Good composite](../images/chapter_05/figure_fic_gc.png){width=670px}
...
```
![Figure 13. Median value image from a collection](../images/chapter_05/figure_ric.png){width=760px}
...
![Figure 14. Median value image from a collection](../images/chapter_05/figure_ric_01.png){width=670px}
...
![Figure 15. Linear trend of MODIS Enhanced Vegetation Index (EVI)](../images/chapter_05/figure_ric_02.png){width=670px}
...
![Figure 16. Maxium value composite](../images/chapter_05/figure_cm.png){width=670px}
...
![Figure 17. Spatial mosaic](../images/chapter_05/figure_cm_01.png){width=670px}
...
![](../images/chapter_05/figure_cm_02.png){width=670px}
...
![Figure 18. National Agriculture Imagery Program (NAIP) Digital Orthophoto Quarter Quadrangle (DOQQ)](../images/chapter_05/figure_cm_02_1.png){width=670px}
...
![](../images/chapter_05/figure_cm_03.png){width=670px}

```{r,eval=FALSE}
Map$addLayer(greenestPixelComposite, vizParams, "greenest pixel composite")
```

![](../images/chapter_05/figure_cm_04.png){width=670px}
...
Map$addLayer(
  ...
  name <- "cloudy")
```
![](../images/chapter_05/figure_cm_05.png){width=670px}
...
![Cumulative anomalies](../images/chapter_05/figure_ioi.png){width=670px}
...
print("Arizona forest disturbance and recovery:", Chart$image$series(cumulative, pt3, ee$Reducer$first(), 500)$getInfo()$setOptions(title))
```
